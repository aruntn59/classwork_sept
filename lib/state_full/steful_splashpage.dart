...
void main() {
  ...
  runApp(MaterialApp(
    ...
    home: steful_splashpage(), // initial page to be launched while running an app
  ));
}
class steful_splashpage extends StatefulWidget{
  @override
  State<StatefulWidget> createState() => steful_splashpage_state();
}
class steful_splashpage_state extends State {
  @override
  void initState() {
